...
!
  ...
  integer line_number
  character ( len = 100 ) module
  character ( len = 100 ) module_file_name
  character ( len = 100 ) module_name
  ...
  logical output_open
  integer output_unit
  character ( len = 4 ) s_module_number
!
...
!
  ...
  do
    ...
    if ( ios /= 0 ) then
      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'F90SPLIT - Reached end of input.'
      exit
    end if

    line_number = line_number + 1
!
!  If we don't have a module name, then we're copying everything to JUNK.
!  So it's important to check whether the next line marks the beginning of
!  a named module.
!
    if ( no_name ) then
...
!
  ...
  if ( line2(1:9) == 'blockdata' ) then
    if ( line2(10:) == ' ' ) then
      name = 'blockdata'
    else
      call s_before_ss_copy ( line2(10:), '(', name )
    end if
  else if ( line2(1:17) == 'characterfunction' ) then
    call s_before_ss_copy ( line2(18:), '(', name )
  else if ( line2(1:15) == 'complexfunction'  ) then
    call s_before_ss_copy ( line2(16:), '(', name )
  else if ( line2(1:23) == 'doubleprecisionfunction'  ) then
    call s_before_ss_copy ( line2(24:), '(', name )
  else if ( line2(1:8) == 'function'  ) then
    call s_before_ss_copy ( line2(9:), '(', name )
  else if ( line2(1:15) == 'integerfunction'  ) then
    call s_before_ss_copy ( line2(16:), '(', name )
  else if ( line2(1:15) == 'logicalfunction'  ) then
    call s_before_ss_copy ( line2(16:), '(', name )
  else if ( line2(1:6) == 'module'  ) then
    call s_before_ss_copy ( line2(7:), '(', name )
  else if ( line2(1:7) == 'program'  ) then
    call s_before_ss_copy ( line2(8:), '(', name )
  else if ( line2(1:12) == 'realfunction'  ) then
    call s_before_ss_copy ( line2(13:), '(', name )
  else if ( line2(1:17) == 'recursivefunction'  ) then
    call s_before_ss_copy ( line2(18:), '(', name )
  else if ( line2(1:10) == 'subroutine' ) then
